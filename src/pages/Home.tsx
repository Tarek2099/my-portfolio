const Home = () => {
  return (
    <div className="home pt-20 flex flex-col justify-center items-center mx-auto sm:max-w-7xl md:max-w-7xl lg:maz-w-7xl h-screen">
      <img
        src="tarek.png"
      ...
      <h1 className="text-6xl font-bold my-5 text-center sm:max-w-3xl md:max-w-3xl lg:max-w-3xl">
